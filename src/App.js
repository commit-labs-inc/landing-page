  ...
  return (
    <div className="bg-white">
      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                  <span className="text-custom-dark_blue">Experiences, </span>
                  <span className="bg-custom-secondary_dark text-white rounded-md px-2">
                    barrier-free.
                  </span>
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Scientific research and software engineering opportunities without interview, transform your skills into
                  experiences easily.
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full px-4 py-1.5 text-lg leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a href="#" className="font-semibold text-custom-ternary_dark">
        ...
        {/* Roadmap section */}
        <div className="mx-auto max-w-4xl text-center mt-32">
